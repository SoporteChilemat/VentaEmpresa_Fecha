...
public class VentanaActualizar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EDUARDO VEGA", "CARLOS MATURANA" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean actualizaCoordinadorVendedor = AsignacionCoordinadorDAO.actualizaCoordinadorVendedor(jLabel2.getText(), jComboBox1.getSelectedItem().toString());
        if (actualizaCoordinadorVendedor) {
            JOptionPane.showMessageDialog(Principal.newJFrame, "Actulizado Correctamente!");
        } else {
