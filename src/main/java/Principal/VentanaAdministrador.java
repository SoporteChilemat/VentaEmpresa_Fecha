...
public class VentanaAdministrador extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int selectedIndex = dialogLogin.jComboBox1.getSelectedIndex();
        ...
        if (text.equals(contraseñaAdministrador)) {
            ...
            claseUsuario.setNombre(usuario);
            claseUsuario.setContraseña(contraseña);
            claseUsuario.setTipo(selectedIndex);

            boolean insertUsuario = false;
            try {
                insertUsuario = usuariosDAO.insertUsuario(claseUsuario);
            } catch (IOException ex) {
                Logger.getLogger(VentanaAdministrador.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(VentanaAdministrador.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if (insertUsuario) {
                ...
                VentanaOK dialogOK = new VentanaOK(Principal.newJFrame, true);
                dialogOK.setLocationRelativeTo(Principal.newJFrame);
